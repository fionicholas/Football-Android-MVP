...
class TeamAdapter (private val teamList: List<Team>, private val listener: (Team) -> Unit)
    ...
    class TeamViewHolder (itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItem(football: Team, listener: (Team) -> Unit){
            tvNameTeam.text = football.strTeam
            tvDesc.text = football.strDescriptionEN
            Picasso.get().load(football.strTeamBadge).into(ivPhoto)
